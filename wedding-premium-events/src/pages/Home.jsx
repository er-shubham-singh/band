  ...
  return (
    <div className="w-full">
      ...
      <section className="w-full bg-white py-16 sm:py-24">
        <div className="section-frame">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-sm uppercase tracking-[0.36em] text-emerald-700 font-semibold">Signature offerings</p>
      ...
      <section className="w-full bg-slate-50 py-16 sm:py-24">
        <div className="section-frame">
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              <p className="text-sm uppercase tracking-[0.35em] text-emerald-700 font-semibold">Trusted by modern couples</p>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {[
                ...
                <div key={item.label} className="rounded-[28px] border border-slate-200 bg-white p-6 text-center shadow-sm">
                  <p className="text-4xl font-semibold text-emerald-700">{item.value}</p>
      ...
      <section className="w-full bg-white py-16 sm:py-24">
        <div className="section-frame">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-sm uppercase tracking-[0.35em] text-emerald-700 font-semibold">Gallery preview</p>
      ...
      <section className="w-full bg-slate-50 py-16 sm:py-24">
        <div className="section-frame">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-sm uppercase tracking-[0.35em] text-emerald-700 font-semibold">Client praise</p>
