  ...
  return (
    <section id="packages" className="w-full bg-white py-16 sm:py-24">
      <div className="section-frame">
        <div className="relative rounded-[40px] border border-slate-200 bg-gradient-to-br from-emerald-50 to-white p-8 shadow-lg sm:p-12">
          <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
            <div>
              <p className="text-sm uppercase tracking-[0.38em] text-emerald-700 font-semibold">Let's begin</p>
