  ...
  return (
    <footer className="border-t border-white/70 bg-white/80 pt-12 pb-8 backdrop-blur-xl">
      <div className="section-frame grid gap-10 lg:grid-cols-[1.2fr_0.8fr] xl:gap-16">
        <div>
          <p className="text-sm uppercase tracking-[0.4em] text-emerald-700">Emerald Events</p>
        ...
        <div className="grid gap-6 sm:grid-cols-2 sm:gap-8">
          <div className="rounded-[28px] bg-slate-950/5 p-6 shadow-[0_28px_70px_rgba(15,23,42,0.06)]">
            ...
            <div className="mt-6 space-y-4 text-sm text-slate-700">
              <div className="flex items-center gap-3">
                <FiPhoneCall className="h-5 w-5 text-emerald-600" />
          ...
          <div className="rounded-[28px] bg-slate-950/5 p-6 shadow-[0_28px_70px_rgba(15,23,42,0.06)]">
            ...
            <div className="mt-6 flex items-center gap-3 text-emerald-700">
              <a href="#" className="rounded-2xl border border-slate-200 bg-white p-3 shadow-sm shadow-slate-200/50 transition hover:bg-emerald-50"><RiFacebookLine className="h-5 w-5" /></a>
              <a href="#" className="rounded-2xl border border-slate-200 bg-white p-3 shadow-sm shadow-slate-200/50 transition hover:bg-emerald-50"><RiInstagramLine className="h-5 w-5" /></a>
              <a href="#" className="rounded-2xl border border-slate-200 bg-white p-3 shadow-sm shadow-slate-200/50 transition hover:bg-emerald-50"><RiTwitterLine className="h-5 w-5" /></a>
            </div>
      ...
      <div className="mt-10 border-t border-slate-200/80 pt-6 text-sm text-slate-500">
        <div className="section-frame flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <p>© 2026 Emerald Events. All rights reserved.</p>
